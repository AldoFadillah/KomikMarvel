...
public class fotoadaptercaptainamerika5 extends PagerAdapter {
    int[] adaptergambarhero;
    Activity adapteractivity;

    public fotoadaptercaptainamerika5( int[] gambarhero, captainamerica5 captainamerica5) {
        adaptergambarhero = gambarhero;
        adapteractivity= captainamerica5;
    }
    @Override
    public  Object instantiateItem(ViewGroup container, int position) {
        LayoutInflater inflaterfoto = (LayoutInflater) adapteractivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View viewfoto = inflaterfoto.inflate(R.layout.layout_captainamerika5,container, false);

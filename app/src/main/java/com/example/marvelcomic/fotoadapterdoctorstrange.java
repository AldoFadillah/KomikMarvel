...
public class fotoadapterdoctorstrange extends PagerAdapter {
    int[] adaptergambarhero;
    Activity adapteractivity;

    public fotoadapterdoctorstrange( int[] gambarhero, doctorstrange doctorstrange) {
        adaptergambarhero = gambarhero;
        adapteractivity= doctorstrange;
    }
    @Override
    public  Object instantiateItem(ViewGroup container, int position) {
        LayoutInflater inflaterfoto = (LayoutInflater) adapteractivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View viewfoto = inflaterfoto.inflate(R.layout.layout_doctorstrange,container, false);

...
public class fotoadaptercaptainamerika3 extends PagerAdapter {
    int[] adaptergambarhero;
    Activity adapteractivity;

    public fotoadaptercaptainamerika3( int[] gambarhero, captainamerica3 captainamerica3) {
        adaptergambarhero = gambarhero;
        adapteractivity= captainamerica3;
    }
    @Override
    public  Object instantiateItem(ViewGroup container, int position) {
        LayoutInflater inflaterfoto = (LayoutInflater) adapteractivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View viewfoto = inflaterfoto.inflate(R.layout.layout_captainamerika3,container, false);

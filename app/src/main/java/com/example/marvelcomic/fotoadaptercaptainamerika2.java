...
public class fotoadaptercaptainamerika2 extends PagerAdapter {
    int[] adaptergambarhero;
    Activity adapteractivity;

    public fotoadaptercaptainamerika2( int[] gambarhero, captainamerica2 captainamerica2) {
        adaptergambarhero = gambarhero;
        adapteractivity= captainamerica2;
    }
    @Override
    public  Object instantiateItem(ViewGroup container, int position) {
        LayoutInflater inflaterfoto = (LayoutInflater) adapteractivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View viewfoto = inflaterfoto.inflate(R.layout.layout_captainamerika2,container, false);

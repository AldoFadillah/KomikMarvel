...
public class fotoadaptercivilwar4 extends PagerAdapter {
    int[] adaptergambarhero;
    Activity adapteractivity;

    public fotoadaptercivilwar4( int[] gambarhero, civilwar4 civilwar4) {
        adaptergambarhero = gambarhero;
        adapteractivity= civilwar4;
    }
    @Override
    public  Object instantiateItem(ViewGroup container, int position) {
        LayoutInflater inflaterfoto = (LayoutInflater) adapteractivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View viewfoto = inflaterfoto.inflate(R.layout.layout_civilwar4,container, false);

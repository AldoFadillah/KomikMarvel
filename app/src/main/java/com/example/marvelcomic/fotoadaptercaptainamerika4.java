...
public class fotoadaptercaptainamerika4 extends PagerAdapter {
    int[] adaptergambarhero;
    Activity adapteractivity;

    public fotoadaptercaptainamerika4( int[] gambarhero, captainamerica4 captainamerica4) {
        adaptergambarhero = gambarhero;
        adapteractivity= captainamerica4;
    }
    @Override
    public  Object instantiateItem(ViewGroup container, int position) {
        LayoutInflater inflaterfoto = (LayoutInflater) adapteractivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View viewfoto = inflaterfoto.inflate(R.layout.layout_captainamerika4,container, false);

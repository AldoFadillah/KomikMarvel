...
public class fotoadaptercaptainamerika1 extends PagerAdapter {
    int[] adaptergambarhero;
    Activity adapteractivity;

    public fotoadaptercaptainamerika1( int[] gambarhero, captainamerica1 captainamerica1) {
        adaptergambarhero = gambarhero;
        adapteractivity= captainamerica1;
    }
    @Override
    public  Object instantiateItem(ViewGroup container, int position) {
        LayoutInflater inflaterfoto = (LayoutInflater) adapteractivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View viewfoto = inflaterfoto.inflate(R.layout.layout_captainamerika1,container, false);
